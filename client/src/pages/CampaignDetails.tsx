...
const CampaignDetails = () => {
  ...
  const { getDonations, fundCampaign, contract, address } = React.useContext(StateContext) as ContractContextType;
        ...
        <div className='flex-[2] flex flex-col gap-[40px]'>
          <div>
            ...
            <div className='flex mt-[20px] flex-row items-center flex-wrap gap-[14px]'>
              ...
              <div>
                ...
                <p className='mt-4 font-epilogue font-normal text-[12px] text-[#808191]'>10 Campaigns</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className='mt-[20px] flex flex-col gap-4'>
              {donators.length > 0 ? donators.map((donator: any, index: number) => (
                <div
                  key={`${donator.donator}-${index}`}
                  className='flex justify-between items-center gap-4'
                >
                  <p className='font-epilogue font-normal text-[16px] leading-[26px] text-[#b2b3bd] break-all'>{index + 1}. {donator.donator}</p>
                  <p className='font-epilogue font-normal text-[16px] leading-[26px] text-[#808191] break-all'>{donator.donation}</p>
                </div>
              )) : (
